class AdminMedicalSupplyItemsController < ApplicationController
  ...
  def create
    ...
    if item.save
      ...
      redirect_to admin_camp_team_page_path(@camp, @camp_team, section: "medical_supplies"), notice: "Eintrag wurde gespeichert."
    else
      redirect_to admin_camp_team_page_path(@camp, @camp_team, section: "medical_supplies"), alert: item.errors.full_messages.to_sentence
    end
  end
  ...
  def update
    ...
    if item.update(medical_supply_item_params)
      ...
      redirect_to admin_camp_team_page_path(@camp, @camp_team, section: "medical_supplies"), notice: "Eintrag wurde aktualisiert."
    else
      redirect_to admin_camp_team_page_path(@camp, @camp_team, section: "medical_supplies"), alert: item.errors.full_messages.to_sentence
    end
  end
  ...
  def destroy
    ...
    redirect_to admin_camp_team_page_path(@camp, @camp_team, section: "medical_supplies"), notice: "Eintrag wurde entfernt."
  end
