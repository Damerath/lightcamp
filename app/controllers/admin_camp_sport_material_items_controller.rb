class AdminCampSportMaterialItemsController < ApplicationController
  ...
  def create
    ...
    if item.save
      ...
      redirect_to admin_camp_team_page_path(@camp, @camp_team, section: "sport_plan"), notice: "Material wurde hinzugefügt."
    else
      redirect_to admin_camp_team_page_path(@camp, @camp_team, section: "sport_plan"), alert: item.errors.full_messages.to_sentence
    end
  end
  ...
  def update
    ...
    if item.update(camp_sport_material_item_params)
      ...
      redirect_to admin_camp_team_page_path(@camp, @camp_team, section: "sport_plan"), notice: "Material wurde aktualisiert."
    else
      redirect_to admin_camp_team_page_path(@camp, @camp_team, section: "sport_plan"), alert: item.errors.full_messages.to_sentence
    end
  end
  ...
  def destroy
    ...
    redirect_to admin_camp_team_page_path(@camp, @camp_team, section: "sport_plan"), notice: "Material wurde entfernt."
  end
