class AdminCampProgramWeekBlocksController < ApplicationController
  ...
  def create
    ...
    if block.save
      ...
      redirect_to admin_camp_team_page_path(@camp, @camp_team, section: "week_plan"), notice: "Wochenplan-Block wurde gespeichert."
    else
      redirect_to admin_camp_team_page_path(@camp, @camp_team, section: "week_plan"), alert: block.errors.full_messages.to_sentence
    end
  end
  ...
  def update
    ...
    if block.update(camp_program_week_block_params)
      sync_matching_colors!(block)
      redirect_to admin_camp_team_page_path(@camp, @camp_team, section: "week_plan"), notice: "Wochenplan-Block wurde aktualisiert."
    else
      redirect_to admin_camp_team_page_path(@camp, @camp_team, section: "week_plan"), alert: block.errors.full_messages.to_sentence
    end
  end
  ...
  def destroy
    ...
    redirect_to admin_camp_team_page_path(@camp, @camp_team, section: "week_plan"), notice: "Wochenplan-Block wurde entfernt."
  end
